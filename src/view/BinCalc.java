...
/**
 * GUI associated with Binary Calculations
 */
public class BinCalc extends JFrame {

    BinCalc() {
        JLabel header = new JLabel("Binary Calculator");
        ...
        // Arithmetic
        {
            ...
            calculateMath.addActionListener(e -> {
                String command =
                        "calculate binary " + Objects.requireNonNull(operator.getSelectedItem()).toString().trim() + " " + mathTextOne.getText().trim() + " " + mathTextTwo.getText().trim();
        ...
        // Convert Binary to Decimal
        {
            ...
            JLabel calcTypeLabel = new JLabel("Convert Binary Value to Decimal Value");

            midPanel.add(calcTypeLabel);
            JPanel input = new JPanel();

            JLabel label = new JLabel("Binary Value:");
            ...
            convertButton.addActionListener(e -> {
                String command = "convert binary to decimal " + binaryTextField.getText();
        ...
        // Convert Decimal Value to Binary Value
        {
            ...
            JLabel calcTypeLabel = new JLabel("Convert Decimal Value to Binary Value");
            ...
            convertButton.addActionListener(e -> {
                String command = "convert decimal to binary " + binaryTextField.getText();
                calculationArea.setText(Director.interpreter(command));
            });
